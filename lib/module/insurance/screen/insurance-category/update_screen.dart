...
class UpdateInsuranceCategory extends ConsumerStatefulWidget {
  final Animation<double> animation;
  final InsuranceCategory data;
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _UpdateInsuranceCategoryState();
}

class _UpdateInsuranceCategoryState
    extends ConsumerState<UpdateInsuranceCategory> {
  ...
  void initState() {
    super.initState();
    // print(widget.data.insuranceType.id);
    _nameController.text = widget.data.name;
    _codeController.text = widget.data.code;
    _noteController.text = widget.data.notes;
    _isSelected = widget.data.socialInsurance == "Yes" ? true : false;
    selectedType = widget.data.insuranceType.id;
  }
